...
class DetailedFavouriteActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detailed_favourites)

        showImage(this)
    }

    fun showImage(context: Context) {
            val joke = intent.getParcelableExtra<FavouriteJoke>("joke")
            if (joke != null) {
